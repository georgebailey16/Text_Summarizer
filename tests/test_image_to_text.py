...
class ImageText(unittest.TestCase):
    ...
    def test_image(self):
        ...
        test_image = Image("Steezus Christ",
                           "../images/74cd5f7c132ba6c02cec6e3ea6d981b18c8e26e44f566325198d613040583e5e_3.jpeg")
    ...
    def test_image_list(self):
        ...
        print(test_list)
        test_image = Image("Last of Us Poster", "../images/lastofus.jpeg")
        test_list.add_image_to_list(test_image)
        self.assertEqual(1, len(test_list.get_gallery()))
        print(test_list)
        test_image = Image("Comp 172 Syllabus", "../images/Screen Shot 2023-05-01 at 4.56.47 PM.png")
        test_list.add_image_to_list(test_image)
        self.assertEqual(2, len(test_list.get_gallery()))
        test_image = Image("I Want You Poster", "../images/J._M._Flagg,_I_Want_You_for_U.S._Army_poster_(1917).jpeg")
        test_list.add_image_to_list(test_image)
        test_image = Image("Steezus Christ",
                           "../images/74cd5f7c132ba6c02cec6e3ea6d981b18c8e26e44f566325198d613040583e5e_3.jpeg")
        test_list.add_image_to_list(test_image)
        self.assertEqual(4, len(test_list.get_gallery()))
        print(test_list)
        print(test_list.get_gallery())
        test_list.sort_a_to_z()
        print(test_list.get_gallery())
